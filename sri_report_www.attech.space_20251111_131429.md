...
**Ngày phân tích:** 11/11/2025 13:14:29  
...
python3 scanSRI.py https://www.attech.space
```
...
|-----|-----|-------------|--------|
| `https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/boo...` | ❌ Thiếu | ❌ | ❌ |
...
| `https://fonts.googleapis.com/css2?family=Roboto:wght@300;400...` | ❌ Thiếu | ❌ | ❌ |
| `https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/ani...` | ❌ Thiếu | ❌ | ❌ |
...
**6/6 external resources THIẾU SRI:**

**Vấn đề:**
- 🔴 Tất cả 6 external resources đều THIẾU SRI
...
| Resources với SRI | ❌ 0 | 0% coverage | 0/100 |
| Resources thiếu SRI | ❌ 6 | Cần khắc phục | - |

**Tổng điểm bảo vệ:** 0/100

🔴 **Đánh giá:** KHÔNG CÓ BẢO VỆ - Không có SRI nào
...
test('All external resources have SRI', async ({ page }) => {
  await page.goto('https://www.attech.space');
