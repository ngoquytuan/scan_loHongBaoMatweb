...
**Ngày phân tích:** 11/11/2025 12:59:53  
...
curl -I https://www.attech.space | grep -i "content-security\|x-frame\|x-content-type"
```
...
python3 scanCSP.py https://www.attech.space
```
...
**Rủi ro:** Website không có bất kỳ CSP protection nào!
...
### 🔴 Trường hợp HIỆN TẠI (KHÔNG có CSP):
...
|----------|---------|----------|------|
| CSP Header | ❌ KHÔNG | Thiếu hoàn toàn | 0/30 |
| default-src | ❌ THIẾU | Cần có | 0/20 |
| script-src | ❌ THIẾU | Rất quan trọng | 0/25 |
| frame-ancestors | ❌ THIẾU | Khuyến nghị có | 0/10 |
| object-src | ❌ THIẾU | Nên disable | 0/10 |

**Tổng điểm bảo vệ:** 0/100

🔴 **Đánh giá:** KHÔNG CÓ BẢO VỆ - Thiếu hoàn toàn CSP

### Vấn đề phát hiện:

- ❌ Thiếu hoàn toàn Content-Security-Policy header
...
1. Mở https://www.attech.space trong Chrome
2. F12 → Console
...
# Mozilla Observatory
https://observatory.mozilla.org/analyze/www.attech.space
```
...
```bash
# Tạo test violation
curl -X POST https://www.attech.space/csp-violation-report \
